...
def run(playwright):
    ...
    import os
    file_path = f"file://{os.getcwd()}/fakoshop.html"
    page.goto(file_path)
    ...
    # Apply Invert Filter (Updated for new UI: Button is "Invert")
    page.click("button:has-text('Invert')")

    # Take screenshot
    page.screenshot(path="verification/screenshot_single_file_final.png")
